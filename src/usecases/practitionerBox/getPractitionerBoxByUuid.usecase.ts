...
export interface GetPractitionerBoxByUuidUsecaseInterface {
  getPractitionerBoxByUuid({ practitionerBoxUuid }: GetPractitionerBoxDto): Promise<ReturnValueType<PractitionerAndBox>>;
}
...
implements GetPractitionerBoxByUuidUsecaseInterface
{
  ...
  async getPractitionerBoxByUuid({ practitionerBoxUuid }: GetPractitionerBoxDto): Promise<ReturnValueType<PractitionerAndBox>> {
