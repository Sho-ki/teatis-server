...
import { GetCustomerMicroGoalsRequestDto } from '../../controllers/customerMicroGoal/dtos/getCustomerMicroGoals.dto';
...
import { CustomerWithMicroGoalDto } from '../../controllers/ResponseDtos/CustomerWithMicroGoal.dto';
import { MicroGoalDto } from '../../controllers/ResponseDtos/MicroGoal.dto';
...
export interface GetCustomerMicroGoalsUsecaseInterface {
  execute({ uuid }: GetCustomerMicroGoalsRequestDto): Promise<
    ReturnValueType<CustomerWithMicroGoalDto>
  >;
}
...
implements GetCustomerMicroGoalsUsecaseInterface {
  ...
  private transformActionSteps(
    ...
    : ActionStepDto[] {
    return actionSteps.map((actionStep): ActionStepDto => {
  ...
  async execute({ uuid }: GetCustomerMicroGoalsRequestDto): Promise<
    ...
    const response: CustomerWithMicroGoalDto =
