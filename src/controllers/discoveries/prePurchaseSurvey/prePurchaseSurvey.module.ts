...
@Module({
  ...
  providers: [
    {
      provide: 'GetPrePurchaseSurveyEmployeeUsecaseInterface',
      useClass: GetPrePurchaseSurveyEmployeeUsecase,
    },
    {
      provide: 'GetPrePurchaseSurveyDriverUsecaseInterface',
      useClass: GetPrePurchaseSurveyDriverUsecase,
    },
    {
