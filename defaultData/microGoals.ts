...
const hydrationMicroGoals: MicroGoalType[] = [
    ...
    actionSteps: [
      {
        ...
        subText: undefined,
        reason: 'Starting the day with water can help kickstart your hydration.',
      },
      {
        id: 20,
        order: 2,
        ...
        subText: undefined,
        reason: 'Drinking water with meals can help you meet your daily hydration goals.',
      },
      {
        id: 21,
        order: 3,
  ...
  {
    id: 7,
    label: 'Try sugar-free drinks for improved hydration without raising blood sugar levels.',
    subCategory: { name: MicroGoalSubCategoryTypes.SugarFreeDrinks },
    actionSteps: [
      {
        id: 24,
        order: 1,
        mainText: 'Choose sugar-free options when ordering/buying drinks.',
        subText: undefined,
        reason: 'Sugar-free drinks can help maintain hydration without raising blood sugar levels.',
      },
      {
        id: 25,
        order: 2,
        mainText: 'Pack sugar-free drinks in the truck for on-the-go hydration.',
        subText: undefined,
        reason: 'Having sugar-free drinks on hand can help ensure you stay hydrated throughout the day.',
      },
      {
        id: 26,
        order: 3,
        mainText: 'Try different sugar-free drink options, such as sparkling water, herbal tea, or coconut water.',
        subText: undefined,
        reason: 'Experimenting with various sugar-free drinks can help you find options that you enjoy.',
      },
      {
        id: 27,
        order: 4,
      ...
      },
      {
        id: 28,
        order: 5,
        mainText: 'Track your daily fluid intake and aim to consume at least 8-10 cups (64-80 ounces) of water or other fluids each day.',
        subText: undefined,
